...
const flow = [
  ...
  { title: <>Управление<br />портфелем</>, copy: "QCM совершает торговые операции и управляет портфелем в соответствии с разработанным финансовым планом.", Icon: ChartIcon },
